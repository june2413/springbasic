...
public class HelloSpring5App07 {
	...
	// @Component : 일반적인 클래스 객체에 사용 (빈정의시 사용)
	// @Service : 주로 서비스 객체에 사용 (빈정의시 사용)
	// @Repository : 주로 DAO 객체에 사용 (빈정의시 사용)
	...
	public static void main(String[] args) {
		...
		bean = (HelloSpring5Bean03) ctx.getBean("eng"); bean.sayHello("Spring 5!!");
		bean = (HelloSpring5Bean03) ctx.getBean("jpn"); bean.sayHello("スプリング 5!!");
